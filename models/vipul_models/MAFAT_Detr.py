...
from tensorflow.keras.layers import Dense, Flatten, Conv2D, MaxPooling2D, AveragePooling2D, Dropout, GlobalAveragePooling2D, GlobalAveragePooling1D, Concatenate, BatchNormalization
...
class TransformerBlock(layers.Layer):
    def __init__(self, embed_dim, num_heads, ff_dim, rate=0.5):
        ...
        self.ffn = tf.keras.Sequential(
            [layers.Dense(ff_dim, activation="relu"), layers.Dense(ff_dim, activation="relu"), layers.Dense(ff_dim, activation="relu"), layers.Dense(embed_dim),]
        )
