...
from tensorflow.keras.layers import Dense, Flatten, Conv2D, SeparableConv2D, MaxPooling2D, AveragePooling2D, Dropout, GlobalAveragePooling2D, Concatenate, BatchNormalization
...
def create_model(input_shape, init):
	...
	x1 = SeparableConv2D(32, 3, activation="relu", kernel_initializer = init, bias_regularizer='l2', padding='same')(x)
	x1 = BatchNormalization()(x1)
	x2 = SeparableConv2D(32, 1, activation="relu", kernel_initializer = init, bias_regularizer='l2', padding='same')(x1)
	...
	x4 = SeparableConv2D(64, 3, activation="relu", kernel_initializer = init, bias_regularizer='l2', padding='same')(x3)
	x4 = BatchNormalization()(x4)
	x5 = SeparableConv2D(64, 3, activation="relu", kernel_initializer = init, bias_regularizer='l2', padding='same')(x4)
	x5 = BatchNormalization()(x5)
	x6 = Concatenate()([x3,x5])

	x7 = SeparableConv2D(96, 3, activation="relu", kernel_initializer = init, bias_regularizer='l2', padding='same')(x6)
	x7 = BatchNormalization()(x7)
	x8 = SeparableConv2D(96, 3, activation="relu", kernel_initializer = init, bias_regularizer='l2', padding='same')(x7)
	x8 = BatchNormalization()(x8)
	x9 = Concatenate()([x6,x8])

	x10 = SeparableConv2D(128, 3, activation="relu", kernel_initializer = init, bias_regularizer='l2', padding='same')(x9)
	x10 = BatchNormalization()(x10)
	x11 = SeparableConv2D(128, 3, activation="relu", kernel_initializer = init, bias_regularizer='l2', padding='same')(x10)
...
# Model fit
history = model.fit(train_x, train_y, batch_size = batch_size, callbacks=callbacks_list, epochs = no_epochs, 
										validation_data = (val_x, val_y))
