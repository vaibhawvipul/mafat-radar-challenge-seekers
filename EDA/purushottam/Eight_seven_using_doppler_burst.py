...
Aux_back_empty = os.path.join(data_path,'Aux_back_empty')
Aux_back_empty_df = load_data(Aux_back_empty)
Aux_exp = os.path.join(data_path,'Aux_exp')
Aux_exp_df = load_data(Aux_exp)
Aux_synth = os.path.join(data_path,'Aux_synth')
Aux_synth_df = load_data(Aux_synth)
public_test = os.path.join(data_path,'Public_test')
public_test_df = load_data(public_test)
train = os.path.join(data_path,'Train')
train_df = load_data(train)



Aux_back_empty_df = data_preprocess(Aux_back_empty_df.copy())
Aux_exp_df = data_preprocess(Aux_exp_df.copy())
...
# experiment_auxiliary_df = load_data(e26xperiment_auxiliary)
